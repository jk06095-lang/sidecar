 ...
 *
 * FIX: Notification dropdown uses position:fixed to escape overflow-hidden ancestors.
 */
...
export default function TopTabBar({
    ...
    // Calculate fixed dropdown position from bell button
    ...
    return (
        <>
            <div className="h-10 bg-slate-900/80 border-b border-slate-800/60 flex items-center select-none shrink-0 backdrop-blur-sm">
                ...
                <div className="flex items-center gap-0.5 px-2 border-l border-slate-800/60 h-full shrink-0">
                    ...
                    <button
                        ...
                        className={cn(
                            'p-1.5 rounded transition-colors relative ml-1',
            ...
            {/* Notification dropdown — rendered with position:fixed to escape overflow-hidden ancestors */}
            {showNotifications && (
                <div
                    ref={dropdownRef}
                    className="fixed w-[360px] max-h-[480px] bg-slate-900 border border-slate-700 rounded-xl shadow-2xl z-[9999] overflow-hidden animate-slide-up"
