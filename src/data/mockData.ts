...
export const ONTOLOGY_OBJECTS: OntologyObject[] = [
    ...
    // ================================================================
    {
        id: 'vessel-vlcc-apollo',
        type: 'Vessel',
        title: 'VLCC Apollo',
        description: 'VLCC 320K DWT. Awaiting Hormuz transit. Cargo value $120M. Charter $48K/day.',
        properties: {
            vesselType: 'VLCC',
            location: 'Hormuz Strait — Anchorage (Awaiting Transit)',
            riskScore: 78,
            status: 'Awaiting Hormuz transit',
            ...
            ifoDiff: -4.0,
            avgSpeedGoodWx: 14.1,
            stillWaterAvgSpeedGoodWx: 14.3,
            avgCurf: 0.0,
            avgWxf: 0.0,
            cargoValueUsd: 120000000,
            charterRate: 48000,
            dwt: 320000,
            imo: '9876543',
    ...
    {
        id: 'vessel-msc-isabella',
        type: 'Vessel',
        title: 'MSC Isabella',
        description: 'ULCV 24K TEU. Rerouting via Cape of Good Hope. +14 days delay expected.',
        properties: {
            vesselType: 'Container (ULCV)',
            location: 'South Atlantic — Cape of Good Hope Route',
            riskScore: 62,
            status: 'Cape of Good Hope reroute',
            ...
            ifoDiff: 15.0,
            avgSpeedGoodWx: 17.5,
            stillWaterAvgSpeedGoodWx: 18.0,
            avgCurf: -0.3,
            avgWxf: -1.5,
            cargoValueUsd: 890000000,
            charterRate: 65000,
            teu: 24000,
            imo: '9912345',
            flag: 'Panama',
            rerouteReason: 'Hormuz/Suez security risk avoidance',
            extraDays: 14,
            extraFuelCostUsd: 2730000,
            impactValue: 62,
            lat: -34.5,
            lng: 18.5,
        },
...
//   vessel-vlcc-apollo, vessel-msc-isabella, chokepoint-hormuz,
...
export const ONTOLOGY_LINKS: OntologyLink[] = [
    ...
    { id: 'link-hormuz-apollo', sourceId: 'chokepoint-hormuz', targetId: 'vessel-vlcc-apollo', relationType: 'AFFECTED_BY', weight: 0.90, metadata: { label: 'forces delay of transit' } },
    { id: 'link-hormuz-isabella', sourceId: 'chokepoint-hormuz', targetId: 'vessel-msc-isabella', relationType: 'AFFECTED_BY', weight: 0.70, metadata: { label: 'forces reroute via Cape' } },

    // ── Cost factors → Vessel impact ──
    { id: 'link-brent-apollo', sourceId: 'commodity-brent', targetId: 'vessel-vlcc-apollo', relationType: 'TRIGGERS', weight: 0.75, metadata: { label: 'increases voyage cost' } },
    { id: 'link-brent-isabella', sourceId: 'commodity-brent', targetId: 'vessel-msc-isabella', relationType: 'TRIGGERS', weight: 0.65, metadata: { label: 'increases voyage cost' } },
    { id: 'link-wrp-apollo', sourceId: 'insurance-war-risk', targetId: 'vessel-vlcc-apollo', relationType: 'INSURES', weight: 0.85, metadata: { label: 'AWRP surcharge applied' } },
    { id: 'link-wrp-isabella', sourceId: 'insurance-war-risk', targetId: 'vessel-msc-isabella', relationType: 'INSURES', weight: 0.60, metadata: { label: 'AWRP surcharge (reduced, rerouted)' } },
    { id: 'link-vlsfo-apollo', sourceId: 'commodity-vlsfo', targetId: 'vessel-vlcc-apollo', relationType: 'CARRIES', weight: 0.75, metadata: { label: 'fuel cost impact' } },
    { id: 'link-vlsfo-isabella', sourceId: 'commodity-vlsfo', targetId: 'vessel-msc-isabella', relationType: 'CARRIES', weight: 0.80, metadata: { label: 'fuel cost + extra reroute consumption' } },

    // ── Vessel → Port arrival impact ──
    { id: 'link-apollo-busan', sourceId: 'vessel-vlcc-apollo', targetId: 'port-busan', relationType: 'ROUTES_THROUGH', weight: 0.80, metadata: { label: 'causes arrival delay at Busan' } },
    { id: 'link-isabella-singapore', sourceId: 'vessel-msc-isabella', targetId: 'port-singapore', relationType: 'ROUTES_THROUGH', weight: 0.70, metadata: { label: 'causes congestion at Singapore' } },

    // ── Reroute cost factor ──
    { id: 'link-reroute-isabella', sourceId: 'risk-reroute-cost', targetId: 'vessel-msc-isabella', relationType: 'DEPENDS_ON', weight: 0.85, metadata: { label: 'Cape reroute +14 days +$2.7M' } },
    ...
    { id: 'link-market-apollo', sourceId: 'market-vlcc-5yr', targetId: 'vessel-vlcc-apollo', relationType: 'MONITORS', weight: 0.50, metadata: { label: 'asset valuation benchmark' } },
